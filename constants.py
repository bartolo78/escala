...
SOLVER_TIMEOUT_SECONDS = 60.0  # Increased from 30s to handle 5-week schedules
...
NIGHT_SHIFT_CONSECUTIVE_MIN_HOURS = 96  # If night-to-night sequence has 96h+ gap, reduced/no penalty
